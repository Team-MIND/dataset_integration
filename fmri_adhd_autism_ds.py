...
class FMRI_AA(TorchNI):
  ...
  def __init__(self, root_dir, search_path, allow_multiple_files=False, 
    is_train=False, transforms=None, classes=None):
    """Inherits from TorchNI to load fMRI adhd-autism NDA dataset.
    ...
    super(FMRI_AA, self).__init__(root_dir, search_path, scan_type="nii",
      allow_multiple_files=allow_multiple_files, is_train=is_train,
      transforms=transforms, classes=classes)
